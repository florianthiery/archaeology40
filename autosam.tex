...
Mentioned in Archaeology 2.0, data is only usable if data will be shared and is open. Berners Lee also proposed the five star data model \cite{hausenblas_5star} for open data where Linked Data will be the best option, the so called Linked Open Data.
